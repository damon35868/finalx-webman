...
class JwtMiddleware implements MiddlewareInterface
{
    ...
    {
        $errorMessages = config('plugin.finalx.webman.app.middleware.jwt', [
        ...
        if (!$token) {
            [$code, $message] = $errorMessages['signatureInvalid'];
            return new Response(
